...
?>
		<div class="row">
			<div class="col-md-7 order-md-1">
				...
				<?php
				$hidden = array('jenisalat' => $jenisalat, 'dari' => $dari, 'tglreg' => $tglreg);
				echo form_open('app/submit/kpp_sendiri', 'class="needs-validation"',$hidden); ?>
					<div class="mb-3">
					...
					<div class="d-block my-3">
						...
						<div class="custom-control custom-radio">
							<input id="sendiri" name="untuk" value="KPP Sendiri" type="radio" class="custom-control-input" checked required>
							<label class="custom-control-label" for="sendiri">KPP Sendiri</label>
						</div>
						<div class="custom-control custom-radio">
							<input id="lain" name="untuk" value="KPP Lain" type="radio" class="custom-control-input" required>
							<label class="custom-control-label" for="lain">KPP Lain</label>
						</div>
					</div>
					<div class="mb-3">
			...
			<div class="col-md-5 order-md-2 mb-4">
				...
				<ul class="list-group mb-3">
					...
					<li class="list-group-item d-flex justify-content-between lh-condensed">
						<div>
							<h6 class="my-0" id="rev-dari"><?php echo $dari; ?></h6>
	...
	<script>
		$(document).ready(function() {
			$('input[type=radio][name=untuk]').change(function() {
			    if (this.value == 'KPP Lain') {
			        $('.d-block').append('<input type="text" class="form-control mt-2 mb-3" id="ketlain" placeholder="Nama KPP" name="ketlain" required />');
			    }
			    else if (this.value == 'KPP Sendiri') {
			        $('input[type=text][name=ketlain]').remove();
			    }
			});
		});
	</script>
